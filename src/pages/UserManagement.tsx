                ...
                {users.map((userData) => (
                  <TableRow key={userData.id}>
                    ...
                    <TableCell className="text-right">
                      {userData.role === 'admin' ? (
                        <Badge variant="outline" className="bg-gray-100 text-black dark:bg-gray-700 dark:text-white">
                          Protected
                        </Badge>
                      ) : (
                        <Select
                        ...
                        >
                          <SelectTrigger className="w-[180px] px-3 custom-select-trigger text-left">
